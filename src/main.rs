...
fn generate_zpl(num: u32) -> String {
	...
	output.extend_from_slice(&[
		...
		Cow::Owned(format!("^FO150,542^BKN,N,60,N,N,A,B^FD{num:8}^FS")),
		Cow::Borrowed("^FO139,690^XGET0^FS"),
		Cow::Owned(format!("^FO201,790^A0N,37,53^FD{num:8}^FS")),
		Cow::Borrowed("^BY3,2.0"),
		Cow::Owned(format!("^FO150,723^BKN,N,60,N,N,A,B^FD{num:8}^FS")),
		Cow::Owned(format!("^FO201,879^A0N,37,53^FD{num:8}^FS")),
		Cow::Owned(format!("^FO201,610^A0N,37,53^FD{num:8}^FS")),
